  ...
  features: [
    {
      ...
      url: "#",
      image:
        "https://res.cloudinary.com/dy089iwsg/image/upload/v1745505006/Tecnosbal_logo_ccdmij.png",
    },
    {
      id: 2,
      title: "Medición de alta precisión",
      summary:
        "Mediciones de piso para VNA y pasillos robóticos con garantía total. Tecnología avanzada que asegura precisión milimétrica, sin demoras ni errores.",
      url: "#",
      image:
        "https://res.cloudinary.com/dy089iwsg/image/upload/v1745505380/Cogri_logo_ohocoz.png",
    },
    {
      id: 3,
      ...
      url: "#",
      image:
        "https://res.cloudinary.com/dy089iwsg/image/upload/v1745506451/Piso_Logo_kpqqq8.png",
    },
  ],
}
...
const tecnoCMData = {
  features: [
    ...
    },
    {
      ...
      description:
        "Nuestros sistemas de medición utilizan tecnología láser de alta precisión, permitiendo detectar variaciones mínimas en la superficie y generar informes detallados para una corrección exacta.",
    },
    {
      id: 3,
      ...
      description:
        "Desarrollamos planes de corrección específicos para cada cliente, considerando las características únicas de su instalación y los requerimientos particulares de su operación.",
    },
  ],
}
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">
            ¿Qué ofrece TECNOSLAB?
          </h2>
          <p className="text-gray-600 leading-relaxed">
            En TECNOSLAB somos expertos en la aplicación de productos especializados en la reparación
            y/o reconversión de piso industrial para obtener las más altas planicidades requeridas por
            los equipos de manejo de materiales más avanzados tales como sistemas ASRS, AMR o VNA.
            Contamos con productos que garantizan una alta resistencia al desgaste para evitar el
            deterioro generado por los equipos de manejo de materiales que circulan por rutas
            definidas concentrando la exposición al desgaste.
          </p>
        </div>
